...
const getMainPage = (req, res) => {
    ...
    str7 = 'SELECT R.productNum, R.Contents, R.star, S.productName, S.thumbnailImg FROM REVIEW R INNER JOIN SELL_PRODUCT S ON R.productNum = S.productNum ORDER BY inputDate;';
